<?php
class FluidCache_project_emulate_Standard_partial_Emulate8086_50ab57c79fa6475ffc6381f69d7160a9030a0fc9 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
				...
				<div class="panel panel-default">
					<div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <button type="button" class="btn btn-warning btn-circle"><i class="fa fa-check"></i>
                                </button> Save
