<?php
class FluidCache_project_emulate_Standard_partial_Emulate8086_634ee8f69a0b74a321da12a7eeca05937b9294c6 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
			...
			<div class="panel-group" id="accordion">
				<div class="panel panel-default">
					<div class="panel-heading">
                        ...
                        <button type="button" class="btn btn-warning pull-right">Warning</button>
                    </div>
