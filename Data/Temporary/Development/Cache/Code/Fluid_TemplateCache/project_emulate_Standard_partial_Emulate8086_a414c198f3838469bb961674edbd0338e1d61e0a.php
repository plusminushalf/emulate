<?php
class FluidCache_project_emulate_Standard_partial_Emulate8086_a414c198f3838469bb961674edbd0338e1d61e0a extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
				...
				<div class="panel panel-default">
					<div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a><button type="button" class="btn btn-success btn-circle"><i class="fa fa-check"></i>
                                </button> Save</a>
