<?php
class FluidCache_project_emulate_Standard_partial_Emulate8086_550d7845d1ddf3ec07334388c91c0a9f96ceb60f extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
				...
				<div class="panel panel-default">
					<div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a><button type="button" class="btn btn-warning btn-circle"><i class="fa fa-check"></i>
                                </button> Save</a>
