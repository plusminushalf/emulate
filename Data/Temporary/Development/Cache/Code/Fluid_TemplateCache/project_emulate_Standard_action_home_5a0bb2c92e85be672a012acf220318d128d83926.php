<?php
class FluidCache_project_emulate_Standard_action_home_5a0bb2c92e85be672a012acf220318d128d83926 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
    	                                            	...
    	                                            	<h4 class="timeline-title">
                                                            ...
                                                            <div class="btn-group text-muted">
                                                                <a class="dropdown-toggle" data-toggle="dropdown">
                                                                    <small class="text-muted"><i class="fa fa-time"></i><span class="caret"></span></small>
                                                                </a>
