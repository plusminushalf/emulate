<?php
class FluidCache_project_emulate_Standard_action_home_e21ea9fee0e4d4e694c1a0c24f8d993b4ac2f621 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                            	<ul class="nav nav-tabs">
                                    ...
                                    <li><a href="#share" data-toggle="tab">Code Shared</a>
                                    </li>
                                    <li><a href="#shared" data-toggle="tab">Shared with you</a>
                                    </li>
                                </ul>
                                <!-- Tab panes -->
                                <div class="tab-content">
                        	        ...
                        	        <div class="tab-pane fade in" id="shared">
                                		<ul class="timeline">
                            	        	<li>
                                	        	<div class="timeline-panel">
	                                	            <div class="timeline-heading">
