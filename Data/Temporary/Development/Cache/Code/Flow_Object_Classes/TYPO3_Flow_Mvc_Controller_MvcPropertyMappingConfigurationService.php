...
class MvcPropertyMappingConfigurationService extends MvcPropertyMappingConfigurationService_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Mvc\Controller\MvcPropertyMappingConfigurationService', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
