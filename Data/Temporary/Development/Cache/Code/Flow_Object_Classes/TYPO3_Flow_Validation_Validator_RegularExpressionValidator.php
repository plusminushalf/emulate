...
class RegularExpressionValidator extends RegularExpressionValidator_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Validation\Validator\RegularExpressionValidator', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
