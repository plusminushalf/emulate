...
class XliffTranslationProvider extends XliffTranslationProvider_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\I18n\TranslationProvider\XliffTranslationProvider', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
