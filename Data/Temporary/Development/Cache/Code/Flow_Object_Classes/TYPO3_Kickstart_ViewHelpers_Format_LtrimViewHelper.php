...
class LtrimViewHelper extends LtrimViewHelper_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Kickstart\ViewHelpers\Format\LtrimViewHelper', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
