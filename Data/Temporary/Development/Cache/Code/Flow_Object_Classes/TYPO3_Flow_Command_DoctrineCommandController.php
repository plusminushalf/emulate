	 ...
	 protected function emitAfterDatabaseMigration() {
		...
		$result = parent::emitAfterDatabaseMigration();
			...
			try {
					...
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Command\DoctrineCommandController', 'emitAfterDatabaseMigration', $joinPoint->getMethodArguments(), NULL, $result);
