...
class DateTimeConverter extends DateTimeConverter_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Property\TypeConverter\DateTimeConverter', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
