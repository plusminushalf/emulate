...
class ElectronicAddressValidator extends ElectronicAddressValidator_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Party\Domain\Validator\ElectronicAddressValidator', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
