...
class RequestDispatchingAspect extends RequestDispatchingAspect_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Security\Aspect\RequestDispatchingAspect', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
