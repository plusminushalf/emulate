...
class ObjectAccessorNode extends ObjectAccessorNode_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
