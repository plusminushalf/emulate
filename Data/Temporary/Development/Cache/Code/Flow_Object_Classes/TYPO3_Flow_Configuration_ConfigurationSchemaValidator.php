...
class ConfigurationSchemaValidator extends ConfigurationSchemaValidator_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Configuration\ConfigurationSchemaValidator', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
