...
class PropertyOperation extends PropertyOperation_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Eel\FlowQuery\Operations\Object\PropertyOperation', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
