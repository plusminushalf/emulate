...
class LazyLoadingObjectAspect extends LazyLoadingObjectAspect_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Persistence\Generic\Aspect\LazyLoadingObjectAspect', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
