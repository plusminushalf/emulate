...
class SaltedMd5HashingStrategy extends SaltedMd5HashingStrategy_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Security\Cryptography\SaltedMd5HashingStrategy', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
