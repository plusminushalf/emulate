...
class ResultsViewHelper extends ResultsViewHelper_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Fluid\ViewHelpers\Validation\ResultsViewHelper', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
