		...
		$result = parent::authenticate($authenticationToken);
			...
			try {
				...
				$methodArguments['authenticationToken'] = $authenticationToken;
					...
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Security\Authentication\Provider\Typo3OrgSsoProvider', 'authenticate', $joinPoint->getMethodArguments(), NULL, $result);
