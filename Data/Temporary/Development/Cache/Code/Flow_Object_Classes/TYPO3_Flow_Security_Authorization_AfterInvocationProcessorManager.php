...
class AfterInvocationProcessorManager extends AfterInvocationProcessorManager_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Security\Authorization\AfterInvocationProcessorManager', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
