...
class SessionObjectMethodsPointcutFilter extends SessionObjectMethodsPointcutFilter_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Session\Aspect\SessionObjectMethodsPointcutFilter', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
