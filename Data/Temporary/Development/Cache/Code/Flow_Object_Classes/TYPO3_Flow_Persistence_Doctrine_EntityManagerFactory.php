...
class EntityManagerFactory extends EntityManagerFactory_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Persistence\Doctrine\EntityManagerFactory', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
