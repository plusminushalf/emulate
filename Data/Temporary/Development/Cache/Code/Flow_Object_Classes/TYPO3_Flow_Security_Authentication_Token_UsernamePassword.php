...
class UsernamePassword extends UsernamePassword_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Security\Authentication\Token\UsernamePassword', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
