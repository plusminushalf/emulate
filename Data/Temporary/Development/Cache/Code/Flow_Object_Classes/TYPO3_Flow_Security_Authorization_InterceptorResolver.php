...
class InterceptorResolver extends InterceptorResolver_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Security\Authorization\InterceptorResolver', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
