		...
		$result = parent::authenticate($authenticationToken);
			...
			try {
				...
				$methodArguments['authenticationToken'] = $authenticationToken;
					...
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Security\Authentication\Provider\PersistedUsernamePasswordProvider', 'authenticate', $joinPoint->getMethodArguments(), NULL, $result);
