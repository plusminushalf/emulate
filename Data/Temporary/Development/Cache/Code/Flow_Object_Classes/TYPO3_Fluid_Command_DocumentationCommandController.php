...
class DocumentationCommandController extends DocumentationCommandController_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Fluid\Command\DocumentationCommandController', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
