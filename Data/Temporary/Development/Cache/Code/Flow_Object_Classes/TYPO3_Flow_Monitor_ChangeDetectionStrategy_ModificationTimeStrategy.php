...
class ModificationTimeStrategy extends ModificationTimeStrategy_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Monitor\ChangeDetectionStrategy\ModificationTimeStrategy', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
