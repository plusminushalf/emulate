...
class RequireAuthentication extends RequireAuthentication_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Security\Authorization\Interceptor\RequireAuthentication', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
