...
class DateTimeRangeValidator extends DateTimeRangeValidator_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Validation\Validator\DateTimeRangeValidator', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
