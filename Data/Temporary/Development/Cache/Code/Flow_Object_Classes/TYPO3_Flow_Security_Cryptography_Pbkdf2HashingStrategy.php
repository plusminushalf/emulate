...
class Pbkdf2HashingStrategy extends Pbkdf2HashingStrategy_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Security\Cryptography\Pbkdf2HashingStrategy', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
