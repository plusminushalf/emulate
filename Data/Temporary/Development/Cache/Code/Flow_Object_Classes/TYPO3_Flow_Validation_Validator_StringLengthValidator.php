...
class StringLengthValidator extends StringLengthValidator_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Validation\Validator\StringLengthValidator', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
