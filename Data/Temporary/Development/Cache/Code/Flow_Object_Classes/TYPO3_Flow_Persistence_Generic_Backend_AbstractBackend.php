		...
		$result = parent::emitRemovedObject($object);
			...
			try {
				...
				$methodArguments['object'] = $object;
					...
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Persistence\Generic\Backend\AbstractBackend', 'emitRemovedObject', $joinPoint->getMethodArguments(), NULL, $result);
		...
		$result = parent::emitPersistedObject($object, $objectState);
			...
			try {
				...
				$methodArguments['objectState'] = $objectState;
					...
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Persistence\Generic\Backend\AbstractBackend', 'emitPersistedObject', $joinPoint->getMethodArguments(), NULL, $result);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
