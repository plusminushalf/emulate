...
class IdentifierViewHelper extends IdentifierViewHelper_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Fluid\ViewHelpers\Format\IdentifierViewHelper', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
