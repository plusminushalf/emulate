 ...
 */
class Registers extends \project\emulate\Emulators\Emulate8086\Src\Domain\Model\Registers implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::getRegister($register);
    }
